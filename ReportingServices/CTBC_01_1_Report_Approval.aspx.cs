...
{
    public partial class CTBC_01_1_Report_Approval : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                if (lang == "zh-tw")
                {
                    CTBC_01_1.GeneratedClass Rpt = new CTBC_01_1.GeneratedClass();
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=01_4內部稽核報告_[" + dt.Rows[0]["audit_no"].ToString() + "_附錄I_評等定義].docx");
                ...
                {
                    CTBC_01_1.GeneratedClass_en Rpt = new CTBC_01_1.GeneratedClass_en();
                    string tempFile = Server.MapPath(".") + Guid.NewGuid() + ".docx";
                    Rpt.dt = dt;
                    Rpt.CreatePackage(tempFile);
                    byte[] buff = File.ReadAllBytes(tempFile);
