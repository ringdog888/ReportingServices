...
namespace Rpt004CheckNotice
{
    public class GeneratedClass
    {
        ...
        private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
        {
            ...
            charactersWithSpaces1.Text = "183";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "00247562", RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };
            ...
            RunFonts runFonts2 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Bold bold1 = new Bold();
            BoldComplexScript boldComplexScript1 = new BoldComplexScript();
            Color color2 = new Color() { Val = "FF0000" };
            Kern kern2 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize1 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript1 = new FontSizeComplexScript() { Val = "47" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00247562" };

            RunProperties runProperties2 = new RunProperties();
            RunFonts runFonts3 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Bold bold2 = new Bold();
            BoldComplexScript boldComplexScript2 = new BoldComplexScript();
            Color color3 = new Color() { Val = "000000" };
            Kern kern3 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize2 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript2 = new FontSizeComplexScript() { Val = "47" };
            ...
            RunFonts runFonts4 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Bold bold3 = new Bold();
            BoldComplexScript boldComplexScript3 = new BoldComplexScript();
            Color color4 = new Color() { Val = "FF0000" };
            Kern kern4 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize3 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript3 = new FontSizeComplexScript() { Val = "47" };
            ...
            Run run4 = new Run() { RsidRunProperties = "00247562" };

            RunProperties runProperties4 = new RunProperties();
            RunFonts runFonts5 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Bold bold4 = new Bold();
            BoldComplexScript boldComplexScript4 = new BoldComplexScript();
            Color color5 = new Color() { Val = "000000" };
            Kern kern5 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize4 = new FontSize() { Val = "55" };
            FontSizeComplexScript fontSizeComplexScript4 = new FontSizeComplexScript() { Val = "55" };
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00247562", RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties2 = new ParagraphProperties();

            Tabs tabs2 = new Tabs();
            TabStop tabStop5 = new TabStop() { Val = TabStopValues.Left, Position = 360 };
            TabStop tabStop6 = new TabStop() { Val = TabStopValues.Left, Position = 720 };
            TabStop tabStop7 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };
            TabStop tabStop8 = new TabStop() { Val = TabStopValues.Left, Position = 1440 };
            TabStop tabStop9 = new TabStop() { Val = TabStopValues.Left, Position = 1800 };
            TabStop tabStop10 = new TabStop() { Val = TabStopValues.Left, Position = 2160 };
            TabStop tabStop11 = new TabStop() { Val = TabStopValues.Left, Position = 2520 };
            TabStop tabStop12 = new TabStop() { Val = TabStopValues.Left, Position = 2880 };
            TabStop tabStop13 = new TabStop() { Val = TabStopValues.Left, Position = 3240 };
            ...
            Paragraph paragraph3 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };
            ...
            TabStop tabStop20 = new TabStop() { Val = TabStopValues.Left, Position = 2520 };
            TabStop tabStop21 = new TabStop() { Val = TabStopValues.Left, Position = 2880 };
            TabStop tabStop22 = new TabStop() { Val = TabStopValues.Left, Position = 3240 };
            TabStop tabStop23 = new TabStop() { Val = TabStopValues.Left, Position = 3600 };
            TabStop tabStop24 = new TabStop() { Val = TabStopValues.Left, Position = 3960 };
            TabStop tabStop25 = new TabStop() { Val = TabStopValues.Left, Position = 4320 };
            TabStop tabStop26 = new TabStop() { Val = TabStopValues.Left, Position = 4680 };
            TabStop tabStop27 = new TabStop() { Val = TabStopValues.Left, Position = 5040 };
            TabStop tabStop28 = new TabStop() { Val = TabStopValues.Left, Position = 5400 };
            TabStop tabStop29 = new TabStop() { Val = TabStopValues.Left, Position = 5760 };
            TabStop tabStop30 = new TabStop() { Val = TabStopValues.Left, Position = 6120 };
            TabStop tabStop31 = new TabStop() { Val = TabStopValues.Left, Position = 6480 };
            TabStop tabStop32 = new TabStop() { Val = TabStopValues.Left, Position = 6840 };
            TabStop tabStop33 = new TabStop() { Val = TabStopValues.Left, Position = 7200 };
            TabStop tabStop34 = new TabStop() { Val = TabStopValues.Left, Position = 7560 };
            TabStop tabStop35 = new TabStop() { Val = TabStopValues.Left, Position = 7920 };
            TabStop tabStop36 = new TabStop() { Val = TabStopValues.Left, Position = 8280 };
            TabStop tabStop37 = new TabStop() { Val = TabStopValues.Left, Position = 8640 };
            TabStop tabStop38 = new TabStop() { Val = TabStopValues.Left, Position = 9000 };
            ...
            tabs3.Append(tabStop28);
            tabs3.Append(tabStop29);
            tabs3.Append(tabStop30);
            tabs3.Append(tabStop31);
            tabs3.Append(tabStop32);
            tabs3.Append(tabStop33);
            tabs3.Append(tabStop34);
            ...
            RunFonts runFonts8 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color7 = new Color() { Val = "000000" };
            Kern kern8 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize5 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript5 = new FontSizeComplexScript() { Val = "47" };
            ...
            Text text5 = new Text();
            text5.Text = dt.Rows[0]["DeptName"].ToString() + dt.Rows[0]["Title"].ToString();
            ...
            RunFonts runFonts9 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color8 = new Color() { Val = "000000" };
            Kern kern9 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize6 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript6 = new FontSizeComplexScript() { Val = "47" };
            ...
            RunFonts runFonts10 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color9 = new Color() { Val = "000000" };
            Kern kern10 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize7 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript7 = new FontSizeComplexScript() { Val = "47" };
            ...
            Text text7 = new Text();
            text7.Text = dt.Rows[0]["FullName"].ToString();
            ...
            RunFonts runFonts11 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color10 = new Color() { Val = "000000" };
            Kern kern11 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize8 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript8 = new FontSizeComplexScript() { Val = "47" };
            ...
            RunFonts runFonts12 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color11 = new Color() { Val = "000000" };
            Kern kern12 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize9 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript9 = new FontSizeComplexScript() { Val = "47" };
            ...
            Paragraph paragraph4 = new Paragraph() { RsidParagraphAddition = "00B844B3", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties4 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties4 = new ParagraphMarkRunProperties();
            RunFonts runFonts13 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color12 = new Color() { Val = "000000" };
            Kern kern13 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize10 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript10 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties4.Append(runFonts13);
            paragraphMarkRunProperties4.Append(color12);
            paragraphMarkRunProperties4.Append(kern13);
            ...
            run11.Append(tabChar2);

            Run run12 = new Run();

            RunProperties runProperties12 = new RunProperties();
            RunFonts runFonts16 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color13 = new Color() { Val = "000000" };
            Kern kern14 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize11 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript11 = new FontSizeComplexScript() { Val = "47" };

            runProperties12.Append(runFonts16);
            runProperties12.Append(color13);
            runProperties12.Append(kern14);
            runProperties12.Append(fontSize11);
            runProperties12.Append(fontSizeComplexScript11);
            Text text10 = new Text();
            text10.Text = "台端奉調參加查核實習，第";
            ...
            RunFonts runFonts17 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color14 = new Color() { Val = "000000" };
            Kern kern15 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize12 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript12 = new FontSizeComplexScript() { Val = "47" };

            runProperties13.Append(runFonts17);
            runProperties13.Append(color14);
            runProperties13.Append(kern15);
            runProperties13.Append(fontSize12);
            runProperties13.Append(fontSizeComplexScript12);
            Text text11 = new Text();
            text11.Text = dt.Rows[0]["Stage"].ToString();
            ...
            RunFonts runFonts18 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color15 = new Color() { Val = "000000" };
            Kern kern16 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize13 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript13 = new FontSizeComplexScript() { Val = "47" };

            runProperties14.Append(runFonts18);
            runProperties14.Append(color15);
            runProperties14.Append(kern16);
            ...
            RunFonts runFonts19 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color16 = new Color() { Val = "000000" };
            Kern kern17 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize14 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript14 = new FontSizeComplexScript() { Val = "47" };

            runProperties15.Append(runFonts19);
            runProperties15.Append(color16);
            runProperties15.Append(kern17);
            runProperties15.Append(fontSize14);
            runProperties15.Append(fontSizeComplexScript14);
            Text text13 = new Text();
            text13.Text = dt.Rows[0]["sm"].ToString();
            ...
            RunFonts runFonts20 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color17 = new Color() { Val = "000000" };
            Kern kern18 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize15 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript15 = new FontSizeComplexScript() { Val = "47" };

            runProperties16.Append(runFonts20);
            runProperties16.Append(color17);
            runProperties16.Append(kern18);
            ...
            RunFonts runFonts21 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color18 = new Color() { Val = "000000" };
            Kern kern19 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize16 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript16 = new FontSizeComplexScript() { Val = "47" };

            runProperties17.Append(runFonts21);
            runProperties17.Append(color18);
            runProperties17.Append(kern19);
            runProperties17.Append(fontSize16);
            runProperties17.Append(fontSizeComplexScript16);
            Text text15 = new Text();
            text15.Text = dt.Rows[0]["sd"].ToString();
            ...
            RunFonts runFonts22 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color19 = new Color() { Val = "000000" };
            Kern kern20 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize17 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript17 = new FontSizeComplexScript() { Val = "47" };

            runProperties18.Append(runFonts22);
            runProperties18.Append(color19);
            runProperties18.Append(kern20);
            ...
            RunFonts runFonts23 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color20 = new Color() { Val = "000000" };
            Kern kern21 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize18 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript18 = new FontSizeComplexScript() { Val = "47" };

            runProperties19.Append(runFonts23);
            runProperties19.Append(color20);
            runProperties19.Append(kern21);
            ...
            RunFonts runFonts24 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color21 = new Color() { Val = "000000" };
            Kern kern22 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize19 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript19 = new FontSizeComplexScript() { Val = "47" };

            runProperties20.Append(runFonts24);
            runProperties20.Append(color21);
            runProperties20.Append(kern22);
            runProperties20.Append(fontSize19);
            ...
            RunFonts runFonts25 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color22 = new Color() { Val = "000000" };
            Kern kern23 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize20 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript20 = new FontSizeComplexScript() { Val = "47" };

            runProperties21.Append(runFonts25);
            runProperties21.Append(color22);
            runProperties21.Append(kern23);
            runProperties21.Append(fontSize20);
            runProperties21.Append(fontSizeComplexScript20);
            Text text19 = new Text() { Space = SpaceProcessingModeValues.Preserve };
            text19.Text = " " + dt.Rows[0]["em"].ToString();
            ...
            RunFonts runFonts26 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color23 = new Color() { Val = "000000" };
            Kern kern24 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize21 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript21 = new FontSizeComplexScript() { Val = "47" };

            runProperties22.Append(runFonts26);
            runProperties22.Append(color23);
            runProperties22.Append(kern24);
            ...
            RunFonts runFonts27 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color24 = new Color() { Val = "000000" };
            Kern kern25 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize22 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript22 = new FontSizeComplexScript() { Val = "47" };

            runProperties23.Append(runFonts27);
            runProperties23.Append(color24);
            runProperties23.Append(kern25);
            runProperties23.Append(fontSize22);
            runProperties23.Append(fontSizeComplexScript22);
            Text text21 = new Text();
            text21.Text = dt.Rows[0]["ed"].ToString();
            ...
            RunFonts runFonts28 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color25 = new Color() { Val = "000000" };
            Kern kern26 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize23 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript23 = new FontSizeComplexScript() { Val = "47" };

            runProperties24.Append(runFonts28);
            runProperties24.Append(color25);
            runProperties24.Append(kern26);
            runProperties24.Append(fontSize23);
            runProperties24.Append(fontSizeComplexScript23);
            Text text22 = new Text();
            text22.Text = "日，實習分行：" + dt.Rows[0]["AuditDept"].ToString() + "，實習項目：" + dt.Rows[0]["ItemFull"].ToString() + "；請於實習第一日上午";
            ...
            RunFonts runFonts29 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color26 = new Color() { Val = "000000" };
            Kern kern27 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize24 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript24 = new FontSizeComplexScript() { Val = "47" };

            runProperties25.Append(runFonts29);
            runProperties25.Append(color26);
            runProperties25.Append(kern27);
            runProperties25.Append(fontSize24);
            ...
            RunFonts runFonts30 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color27 = new Color() { Val = "000000" };
            Kern kern28 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize25 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript25 = new FontSizeComplexScript() { Val = "47" };

            runProperties26.Append(runFonts30);
            runProperties26.Append(color27);
            runProperties26.Append(kern28);
            runProperties26.Append(fontSize25);
            runProperties26.Append(fontSizeComplexScript25);
            ...
            RunFonts runFonts31 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color28 = new Color() { Val = "000000" };
            Kern kern29 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize26 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript26 = new FontSizeComplexScript() { Val = "47" };

            runProperties27.Append(runFonts31);
            runProperties27.Append(color28);
            runProperties27.Append(kern29);
            runProperties27.Append(fontSize26);
            runProperties27.Append(fontSizeComplexScript26);
            ...
            RunFonts runFonts32 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color29 = new Color() { Val = "000000" };
            Kern kern30 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize27 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript27 = new FontSizeComplexScript() { Val = "47" };

            runProperties28.Append(runFonts32);
            runProperties28.Append(color29);
            runProperties28.Append(kern30);
            runProperties28.Append(fontSize27);
            runProperties28.Append(fontSizeComplexScript27);
            Text text26 = new Text();
            text26.Text = "分前到達實習分行，並向本處領隊稽核" + dt.Rows[0]["Contact"].ToString() + "報到後進行實習。";
            ...
            Paragraph paragraph5 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties5 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties5 = new ParagraphMarkRunProperties();
            RunFonts runFonts33 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color30 = new Color() { Val = "000000" };
            Kern kern31 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize28 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript28 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties5.Append(runFonts33);
            paragraphMarkRunProperties5.Append(color30);
            paragraphMarkRunProperties5.Append(kern31);
            paragraphMarkRunProperties5.Append(fontSize28);
            paragraphMarkRunProperties5.Append(fontSizeComplexScript28);

            paragraphProperties5.Append(paragraphMarkRunProperties5);

            paragraph5.Append(paragraphProperties5);

            Paragraph paragraph6 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties6 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties6 = new ParagraphMarkRunProperties();
            RunFonts runFonts34 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color31 = new Color() { Val = "000000" };
            Kern kern32 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize29 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript29 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties6.Append(runFonts34);
            paragraphMarkRunProperties6.Append(color31);
            paragraphMarkRunProperties6.Append(kern32);
            paragraphMarkRunProperties6.Append(fontSize29);
            paragraphMarkRunProperties6.Append(fontSizeComplexScript29);

            paragraphProperties6.Append(paragraphMarkRunProperties6);

            paragraph6.Append(paragraphProperties6);

            Paragraph paragraph7 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties7 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties7 = new ParagraphMarkRunProperties();
            RunFonts runFonts35 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color32 = new Color() { Val = "000000" };
            Kern kern33 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize30 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript30 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties7.Append(runFonts35);
            paragraphMarkRunProperties7.Append(color32);
            paragraphMarkRunProperties7.Append(kern33);
            paragraphMarkRunProperties7.Append(fontSize30);
            paragraphMarkRunProperties7.Append(fontSizeComplexScript30);

            paragraphProperties7.Append(paragraphMarkRunProperties7);

            paragraph7.Append(paragraphProperties7);

            Paragraph paragraph8 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties8 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties8 = new ParagraphMarkRunProperties();
            RunFonts runFonts36 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color33 = new Color() { Val = "000000" };
            Kern kern34 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize31 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript31 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties8.Append(runFonts36);
            ...
            Paragraph paragraph9 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties9 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties9 = new ParagraphMarkRunProperties();
            RunFonts runFonts37 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color34 = new Color() { Val = "000000" };
            Kern kern35 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize32 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript32 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties9.Append(runFonts37);
            paragraphMarkRunProperties9.Append(color34);
            paragraphMarkRunProperties9.Append(kern35);
            paragraphMarkRunProperties9.Append(fontSize32);
            paragraphMarkRunProperties9.Append(fontSizeComplexScript32);

            paragraphProperties9.Append(paragraphMarkRunProperties9);

            paragraph9.Append(paragraphProperties9);

            Paragraph paragraph10 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties10 = new ParagraphProperties();

            ParagraphMarkRunProperties paragraphMarkRunProperties10 = new ParagraphMarkRunProperties();
            RunFonts runFonts38 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color35 = new Color() { Val = "000000" };
            Kern kern36 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize33 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript33 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties10.Append(runFonts38);
            paragraphMarkRunProperties10.Append(color35);
            paragraphMarkRunProperties10.Append(kern36);
            paragraphMarkRunProperties10.Append(fontSize33);
            paragraphMarkRunProperties10.Append(fontSizeComplexScript33);

            paragraphProperties10.Append(paragraphMarkRunProperties10);

            paragraph10.Append(paragraphProperties10);

            Paragraph paragraph11 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00AE3FA0", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties11 = new ParagraphProperties();
            FrameProperties frameProperties1 = new FrameProperties() { Width = "3000", Height = (UInt32Value)1276U, Wrap = TextWrappingValues.Auto, HorizontalPosition = HorizontalAnchorValues.Page, VerticalPosition = VerticalAnchorValues.Page, X = "5881", Y = "10143", HeightType = HeightRuleValues.Exact };

            Tabs tabs4 = new Tabs();
            TabStop tabStop39 = new TabStop() { Val = TabStopValues.Left, Position = 360 };
            TabStop tabStop40 = new TabStop() { Val = TabStopValues.Left, Position = 720 };
            TabStop tabStop41 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };
            TabStop tabStop42 = new TabStop() { Val = TabStopValues.Left, Position = 1440 };
            TabStop tabStop43 = new TabStop() { Val = TabStopValues.Left, Position = 1800 };
            TabStop tabStop44 = new TabStop() { Val = TabStopValues.Left, Position = 2160 };
            TabStop tabStop45 = new TabStop() { Val = TabStopValues.Left, Position = 2520 };
            TabStop tabStop46 = new TabStop() { Val = TabStopValues.Left, Position = 2880 };
            ...
            tabs4.Append(tabStop45);
            tabs4.Append(tabStop46);
            ...
            RunFonts runFonts39 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color36 = new Color() { Val = "000000" };
            Kern kern37 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize34 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript34 = new FontSizeComplexScript() { Val = "47" };

            paragraphMarkRunProperties11.Append(runFonts39);
            paragraphMarkRunProperties11.Append(color36);
            paragraphMarkRunProperties11.Append(kern37);
            paragraphMarkRunProperties11.Append(fontSize34);
            paragraphMarkRunProperties11.Append(fontSizeComplexScript34);

            paragraphProperties11.Append(frameProperties1);
            paragraphProperties11.Append(tabs4);
            paragraphProperties11.Append(autoSpaceDE4);
            paragraphProperties11.Append(autoSpaceDN4);
            paragraphProperties11.Append(adjustRightIndent4);
            paragraphProperties11.Append(paragraphMarkRunProperties11);

            Run run29 = new Run();

            RunProperties runProperties29 = new RunProperties();
            RunFonts runFonts40 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color37 = new Color() { Val = "000000" };
            Kern kern38 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize35 = new FontSize() { Val = "47" };
            FontSizeComplexScript fontSizeComplexScript35 = new FontSizeComplexScript() { Val = "47" };

            runProperties29.Append(runFonts40);
            runProperties29.Append(color37);
            runProperties29.Append(kern38);
            runProperties29.Append(fontSize35);
            runProperties29.Append(fontSizeComplexScript35);
            ...
            paragraph11.Append(run29);

            Paragraph paragraph12 = new Paragraph() { RsidParagraphMarkRevision = "00AE3FA0", RsidParagraphAddition = "00AE3FA0", RsidParagraphProperties = "00AE3FA0", RsidRunAdditionDefault = "00AE3FA0" };

            ParagraphProperties paragraphProperties12 = new ParagraphProperties();
            FrameProperties frameProperties2 = new FrameProperties() { Width = "3000", Height = (UInt32Value)1276U, Wrap = TextWrappingValues.Auto, HorizontalPosition = HorizontalAnchorValues.Page, VerticalPosition = VerticalAnchorValues.Page, X = "5881", Y = "10143", HeightType = HeightRuleValues.Exact };
            ...
            TabStop tabStop49 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };
            TabStop tabStop50 = new TabStop() { Val = TabStopValues.Left, Position = 1440 };
            TabStop tabStop51 = new TabStop() { Val = TabStopValues.Left, Position = 1800 };
            TabStop tabStop52 = new TabStop() { Val = TabStopValues.Left, Position = 2160 };
            TabStop tabStop53 = new TabStop() { Val = TabStopValues.Left, Position = 2520 };
            TabStop tabStop54 = new TabStop() { Val = TabStopValues.Left, Position = 2880 };
            ...
            paragraphMarkRunProperties12.Append(runFonts41);
            paragraphMarkRunProperties12.Append(kern39);
            paragraphMarkRunProperties12.Append(fontSize36);
            paragraphMarkRunProperties12.Append(fontSizeComplexScript36);

            paragraphProperties12.Append(frameProperties2);
            paragraphProperties12.Append(tabs5);
            paragraphProperties12.Append(autoSpaceDE5);
            paragraphProperties12.Append(autoSpaceDN5);
            paragraphProperties12.Append(adjustRightIndent5);
            paragraphProperties12.Append(paragraphMarkRunProperties12);
            ProofError proofError1 = new ProofError() { Type = ProofingErrorValues.GrammarStart };

            Run run30 = new Run() { RsidRunProperties = "00AE3FA0" };
            ...
            runProperties30.Append(kern40);
            runProperties30.Append(fontSize37);
            runProperties30.Append(fontSizeComplexScript37);
            Text text28 = new Text();
            text28.Text = dt.Rows[0]["Year"].ToString() + "年" + dt.Rows[0]["Month"].ToString() + "月" + dt.Rows[0]["Day"].ToString() + "日";
            ...
            Paragraph paragraph13 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };
            ...
            TabStop tabStop57 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };

            tabs6.Append(tabStop55);
            tabs6.Append(tabStop56);
            tabs6.Append(tabStop57);
            ...
            RunFonts runFonts43 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color38 = new Color() { Val = "FF0000" };
            Kern kern41 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize38 = new FontSize() { Val = "35" };
            FontSizeComplexScript fontSizeComplexScript38 = new FontSizeComplexScript() { Val = "35" };

            paragraphMarkRunProperties13.Append(runFonts43);
            paragraphMarkRunProperties13.Append(color38);
            paragraphMarkRunProperties13.Append(kern41);
            paragraphMarkRunProperties13.Append(fontSize38);
            paragraphMarkRunProperties13.Append(fontSizeComplexScript38);

            paragraphProperties13.Append(tabs6);
            paragraphProperties13.Append(autoSpaceDE6);
            paragraphProperties13.Append(autoSpaceDN6);
            paragraphProperties13.Append(adjustRightIndent6);
            paragraphProperties13.Append(paragraphMarkRunProperties13);

            paragraph13.Append(paragraphProperties13);

            Paragraph paragraph14 = new Paragraph() { RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties14 = new ParagraphProperties();

            Tabs tabs7 = new Tabs();
            TabStop tabStop58 = new TabStop() { Val = TabStopValues.Left, Position = 360 };
            TabStop tabStop59 = new TabStop() { Val = TabStopValues.Left, Position = 720 };
            TabStop tabStop60 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };
            ...
            RunFonts runFonts44 = new RunFonts() { Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color39 = new Color() { Val = "FF0000" };
            Kern kern42 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize39 = new FontSize() { Val = "35" };
            FontSizeComplexScript fontSizeComplexScript39 = new FontSizeComplexScript() { Val = "35" };

            paragraphMarkRunProperties14.Append(runFonts44);
            paragraphMarkRunProperties14.Append(color39);
            paragraphMarkRunProperties14.Append(kern42);
            paragraphMarkRunProperties14.Append(fontSize39);
            paragraphMarkRunProperties14.Append(fontSizeComplexScript39);

            paragraphProperties14.Append(tabs7);
            paragraphProperties14.Append(autoSpaceDE7);
            paragraphProperties14.Append(autoSpaceDN7);
            paragraphProperties14.Append(adjustRightIndent7);
            paragraphProperties14.Append(paragraphMarkRunProperties14);

            paragraph14.Append(paragraphProperties14);

            Paragraph paragraph15 = new Paragraph() { RsidParagraphMarkRevision = "00247562", RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };
            ...
            TabStop tabStop74 = new TabStop() { Val = TabStopValues.Left, Position = 5040 };
            TabStop tabStop75 = new TabStop() { Val = TabStopValues.Left, Position = 5400 };
            TabStop tabStop76 = new TabStop() { Val = TabStopValues.Left, Position = 5760 };
            TabStop tabStop77 = new TabStop() { Val = TabStopValues.Left, Position = 6120 };
            TabStop tabStop78 = new TabStop() { Val = TabStopValues.Left, Position = 6480 };
            TabStop tabStop79 = new TabStop() { Val = TabStopValues.Left, Position = 6840 };
            TabStop tabStop80 = new TabStop() { Val = TabStopValues.Left, Position = 7200 };
            TabStop tabStop81 = new TabStop() { Val = TabStopValues.Left, Position = 7560 };
            TabStop tabStop82 = new TabStop() { Val = TabStopValues.Left, Position = 7920 };

            tabs8.Append(tabStop61);
            tabs8.Append(tabStop62);
            tabs8.Append(tabStop63);
            ...
            tabs8.Append(tabStop73);
            tabs8.Append(tabStop74);
            tabs8.Append(tabStop75);
            tabs8.Append(tabStop76);
            tabs8.Append(tabStop77);
            tabs8.Append(tabStop78);
            tabs8.Append(tabStop79);
            tabs8.Append(tabStop80);
            tabs8.Append(tabStop81);
            tabs8.Append(tabStop82);
            ...
            Indentation indentation1 = new Indentation() { Left = "1416", LeftChars = -1, Hanging = "1418", HangingChars = 405 };
            ...
            paragraphMarkRunProperties15.Append(color40);
            paragraphMarkRunProperties15.Append(kern43);

            paragraphProperties15.Append(tabs8);
            paragraphProperties15.Append(autoSpaceDE8);
            paragraphProperties15.Append(autoSpaceDN8);
            paragraphProperties15.Append(adjustRightIndent8);
            paragraphProperties15.Append(snapToGrid1);
            paragraphProperties15.Append(indentation1);
            paragraphProperties15.Append(justification3);
            paragraphProperties15.Append(paragraphMarkRunProperties15);

            Run run31 = new Run() { RsidRunProperties = "00247562" };

            RunProperties runProperties31 = new RunProperties();
            RunFonts runFonts46 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color41 = new Color() { Val = "000000" };
            Kern kern44 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize40 = new FontSize() { Val = "35" };
            FontSizeComplexScript fontSizeComplexScript40 = new FontSizeComplexScript() { Val = "35" };

            runProperties31.Append(runFonts46);
            runProperties31.Append(color41);
            runProperties31.Append(kern44);
            ...
            runProperties32.Append(noProof1);

            Drawing drawing1 = new Drawing();

            Wp.Anchor anchor1 = new Wp.Anchor() { DistanceFromTop = (UInt32Value)0U, DistanceFromBottom = (UInt32Value)0U, DistanceFromLeft = (UInt32Value)114300U, DistanceFromRight = (UInt32Value)114300U, SimplePos = false, RelativeHeight = (UInt32Value)251659264U, BehindDoc = true, Locked = false, LayoutInCell = false, AllowOverlap = true };
            ...
            positionOffset2.Text = "6363970";

            verticalPosition1.Append(positionOffset2);
            Wp.Extent extent1 = new Wp.Extent() { Cx = 895350L, Cy = 876300L };
            Wp.EffectExtent effectExtent1 = new Wp.EffectExtent() { LeftEdge = 19050L, TopEdge = 0L, RightEdge = 0L, BottomEdge = 0L };
            Wp.WrapNone wrapNone1 = new Wp.WrapNone();
            Wp.DocProperties docProperties1 = new Wp.DocProperties() { Id = (UInt32Value)1U, Name = "圖片 2" };
            ...
            A.Blip blip1 = new A.Blip() { Embed = "rId6", CompressionState = A.BlipCompressionValues.Print };
            ...
            A.Extents extents1 = new A.Extents() { Cx = 895350L, Cy = 876300L };
            ...
            run32.Append(drawing1);

            Run run33 = new Run() { RsidRunProperties = "00247562" };

            RunProperties runProperties33 = new RunProperties();
            RunFonts runFonts47 = new RunFonts() { Hint = FontTypeHintValues.EastAsia, Ascii = "標楷體", EastAsia = "標楷體", ComplexScript = "標楷體" };
            Color color42 = new Color() { Val = "000000" };
            Kern kern45 = new Kern() { Val = (UInt32Value)0U };
            FontSize fontSize41 = new FontSize() { Val = "35" };
            FontSizeComplexScript fontSizeComplexScript41 = new FontSizeComplexScript() { Val = "35" };

            runProperties33.Append(runFonts47);
            runProperties33.Append(color42);
            runProperties33.Append(kern45);
            runProperties33.Append(fontSize41);
            runProperties33.Append(fontSizeComplexScript41);
            Text text30 = new Text();
            text30.Text = "到受查單位實習前，請絕對不可將實習分行及日期事先洩漏，以免受懲處。";
            ...
            paragraph15.Append(run32);
            paragraph15.Append(run33);

            Paragraph paragraph16 = new Paragraph() { RsidParagraphMarkRevision = "00606DE5", RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            ParagraphProperties paragraphProperties16 = new ParagraphProperties();

            Tabs tabs9 = new Tabs();
            TabStop tabStop83 = new TabStop() { Val = TabStopValues.Left, Position = 360 };
            TabStop tabStop84 = new TabStop() { Val = TabStopValues.Left, Position = 720 };
            TabStop tabStop85 = new TabStop() { Val = TabStopValues.Left, Position = 1080 };

            tabs9.Append(tabStop83);
            tabs9.Append(tabStop84);
            tabs9.Append(tabStop85);
            ...
            paragraphMarkRunProperties16.Append(color43);
            paragraphMarkRunProperties16.Append(kern46);

            paragraphProperties16.Append(tabs9);
            paragraphProperties16.Append(autoSpaceDE9);
            paragraphProperties16.Append(autoSpaceDN9);
            paragraphProperties16.Append(adjustRightIndent9);
            paragraphProperties16.Append(paragraphMarkRunProperties16);

            paragraph16.Append(paragraphProperties16);
            Paragraph paragraph17 = new Paragraph() { RsidParagraphMarkRevision = "00606DE5", RsidParagraphAddition = "00606DE5", RsidParagraphProperties = "00606DE5", RsidRunAdditionDefault = "00606DE5" };

            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00606DE5", RsidR = "00606DE5", RsidSect = "00606DE5" };
            PageSize pageSize1 = new PageSize() { Width = (UInt32Value)11906U, Height = (UInt32Value)16838U };
            PageMargin pageMargin1 = new PageMargin() { Top = 1134, Right = (UInt32Value)1077U, Bottom = 1440, Left = (UInt32Value)1077U, Header = (UInt32Value)851U, Footer = (UInt32Value)992U, Gutter = (UInt32Value)0U };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            Ovml.ShapeDefaults shapeDefaults1 = new Ovml.ShapeDefaults() { Extension = V.ExtensionHandlingBehaviorValues.Edit, MaxShapeId = 7170 };
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00606DE5" };
            Rsid rsid1 = new Rsid() { Val = "000B1CD3" };
            Rsid rsid2 = new Rsid() { Val = "000E33F3" };
            Rsid rsid3 = new Rsid() { Val = "004C6398" };
            Rsid rsid4 = new Rsid() { Val = "00606DE5" };
            Rsid rsid5 = new Rsid() { Val = "00853FEF" };
            Rsid rsid6 = new Rsid() { Val = "008F1F75" };
            Rsid rsid7 = new Rsid() { Val = "00A51761" };
            Rsid rsid8 = new Rsid() { Val = "00AE3FA0" };
            Rsid rsid9 = new Rsid() { Val = "00B322B6" };
            Rsid rsid10 = new Rsid() { Val = "00B844B3" };
            Rsid rsid11 = new Rsid() { Val = "00BD20DA" };
            Rsid rsid12 = new Rsid() { Val = "00C05BF7" };
            Rsid rsid13 = new Rsid() { Val = "00EB4556" };
            Rsid rsid14 = new Rsid() { Val = "00FE4FCB" };
            ...
            Ovml.ShapeDefaults shapeDefaults3 = new Ovml.ShapeDefaults() { Extension = V.ExtensionHandlingBehaviorValues.Edit, MaxShapeId = 7170 };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            RunFonts runFonts49 = new RunFonts() { AsciiTheme = ThemeFontValues.MinorHighAnsi, HighAnsiTheme = ThemeFontValues.MinorHighAnsi, EastAsiaTheme = ThemeFontValues.MinorEastAsia, ComplexScriptTheme = ThemeFontValues.MinorBidi };
            Kern kern47 = new Kern() { Val = (UInt32Value)2U };
            ...
            runPropertiesBaseStyle1.Append(runFonts49);
            runPropertiesBaseStyle1.Append(kern47);
            runPropertiesBaseStyle1.Append(fontSize42);
            runPropertiesBaseStyle1.Append(fontSizeComplexScript42);
            ...
            Rsid rsid15 = new Rsid() { Val = "00606DE5" };
            ...
            RunFonts runFonts50 = new RunFonts() { Ascii = "Times New Roman", HighAnsi = "Times New Roman", EastAsia = "新細明體", ComplexScript = "Times New Roman" };
            FontSizeComplexScript fontSizeComplexScript43 = new FontSizeComplexScript() { Val = "24" };

            styleRunProperties1.Append(runFonts50);
            styleRunProperties1.Append(fontSizeComplexScript43);
            ...
            Rsid rsid16 = new Rsid() { Val = "00B322B6" };

            StyleParagraphProperties styleParagraphProperties2 = new StyleParagraphProperties();

            Tabs tabs10 = new Tabs();
            TabStop tabStop86 = new TabStop() { Val = TabStopValues.Center, Position = 4153 };
            TabStop tabStop87 = new TabStop() { Val = TabStopValues.Right, Position = 8306 };

            tabs10.Append(tabStop86);
            tabs10.Append(tabStop87);
            SnapToGrid snapToGrid2 = new SnapToGrid() { Val = false };

            styleParagraphProperties2.Append(tabs10);
            styleParagraphProperties2.Append(snapToGrid2);
            ...
            styleRunProperties2.Append(fontSizeComplexScript44);
            ...
            Rsid rsid17 = new Rsid() { Val = "00B322B6" };

            StyleRunProperties styleRunProperties3 = new StyleRunProperties();
            RunFonts runFonts51 = new RunFonts() { Ascii = "Times New Roman", HighAnsi = "Times New Roman", EastAsia = "新細明體", ComplexScript = "Times New Roman" };
            FontSize fontSize44 = new FontSize() { Val = "20" };
            FontSizeComplexScript fontSizeComplexScript45 = new FontSizeComplexScript() { Val = "20" };

            styleRunProperties3.Append(runFonts51);
            styleRunProperties3.Append(fontSize44);
            styleRunProperties3.Append(fontSizeComplexScript45);
            ...
            Rsid rsid18 = new Rsid() { Val = "00B322B6" };

            StyleParagraphProperties styleParagraphProperties3 = new StyleParagraphProperties();

            Tabs tabs11 = new Tabs();
            TabStop tabStop88 = new TabStop() { Val = TabStopValues.Center, Position = 4153 };
            TabStop tabStop89 = new TabStop() { Val = TabStopValues.Right, Position = 8306 };

            tabs11.Append(tabStop88);
            tabs11.Append(tabStop89);
            SnapToGrid snapToGrid3 = new SnapToGrid() { Val = false };

            styleParagraphProperties3.Append(tabs11);
            styleParagraphProperties3.Append(snapToGrid3);
            ...
            styleRunProperties4.Append(fontSize45);
            styleRunProperties4.Append(fontSizeComplexScript46);
            ...
            Rsid rsid19 = new Rsid() { Val = "00B322B6" };

            StyleRunProperties styleRunProperties5 = new StyleRunProperties();
            RunFonts runFonts52 = new RunFonts() { Ascii = "Times New Roman", HighAnsi = "Times New Roman", EastAsia = "新細明體", ComplexScript = "Times New Roman" };
            FontSize fontSize46 = new FontSize() { Val = "20" };
            FontSizeComplexScript fontSizeComplexScript47 = new FontSizeComplexScript() { Val = "20" };

            styleRunProperties5.Append(runFonts52);
            styleRunProperties5.Append(fontSize46);
            styleRunProperties5.Append(fontSizeComplexScript47);
        ...
        private void GenerateEndnotesPart1Content(EndnotesPart endnotesPart1)
        {
            ...
            Paragraph paragraph18 = new Paragraph() { RsidParagraphAddition = "004C6398", RsidParagraphProperties = "00B322B6", RsidRunAdditionDefault = "004C6398" };

            Run run34 = new Run();
            SeparatorMark separatorMark1 = new SeparatorMark();

            run34.Append(separatorMark1);

            paragraph18.Append(run34);

            endnote1.Append(paragraph18);

            Endnote endnote2 = new Endnote() { Type = FootnoteEndnoteValues.ContinuationSeparator, Id = 0 };

            Paragraph paragraph19 = new Paragraph() { RsidParagraphAddition = "004C6398", RsidParagraphProperties = "00B322B6", RsidRunAdditionDefault = "004C6398" };

            Run run35 = new Run();
            ContinuationSeparatorMark continuationSeparatorMark1 = new ContinuationSeparatorMark();

            run35.Append(continuationSeparatorMark1);

            paragraph19.Append(run35);

            endnote2.Append(paragraph19);
        ...
        private void GenerateFootnotesPart1Content(FootnotesPart footnotesPart1)
        {
            ...
            Paragraph paragraph20 = new Paragraph() { RsidParagraphAddition = "004C6398", RsidParagraphProperties = "00B322B6", RsidRunAdditionDefault = "004C6398" };

            Run run36 = new Run();
            SeparatorMark separatorMark2 = new SeparatorMark();

            run36.Append(separatorMark2);

            paragraph20.Append(run36);

            footnote1.Append(paragraph20);

            Footnote footnote2 = new Footnote() { Type = FootnoteEndnoteValues.ContinuationSeparator, Id = 0 };

            Paragraph paragraph21 = new Paragraph() { RsidParagraphAddition = "004C6398", RsidParagraphProperties = "00B322B6", RsidRunAdditionDefault = "004C6398" };

            Run run37 = new Run();
            ContinuationSeparatorMark continuationSeparatorMark2 = new ContinuationSeparatorMark();

            run37.Append(continuationSeparatorMark2);

            paragraph21.Append(run37);

            footnote2.Append(paragraph21);
