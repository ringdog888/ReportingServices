...
{
    public partial class CTBC_02_8 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = RptTool.ExecSqlQueryParameters(connectionString, @"SELECT   a_list.[startdate] AS startdate,  
...
ON a_list.[plantypeid] = p_list.[guidid] where audit_no='112-022' ", dic);
